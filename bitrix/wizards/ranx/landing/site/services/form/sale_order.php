...
$formCode = 'ranx_landing_sale_order';
...
if ($formId) {
    ...
    // add new
    $arFields = [
        'NAME'				=> Loc::getMessage('SALE_ORDER_FORM_NAME'),
        'SID'				=> $formCode,
        'C_SORT'			=> 300,
        'BUTTON'			=> Loc::getMessage('SALE_ORDER_BUTTON_NAME'),
        'DESCRIPTION'		=> Loc::getMessage('SALE_ORDER_FORM_DESCRIPTION'),
        'DESCRIPTION_TYPE'	=> 'text',
        'STAT_EVENT1'		=> 'form',
        'STAT_EVENT2'		=> '',
        'arSITE'			=> $arFormSiteIds,
        'arMENU'			=> ['ru' => Loc::getMessage('SALE_ORDER_FORM_NAME')],
    ...
    $arFields = [
        'FORM_ID'    => $formId,
        'ACTIVE'     => 'Y',
        'TITLE'      => Loc::getMessage('SALE_ORDER_FORM_QUESTION_1'),
        'TITLE_TYPE' => 'text',
        'SID'        => 'NAME',
        'C_SORT'     => 100,
        'ADDITIONAL' => 'N',
    ...
    $arFields = [
        'FORM_ID'    => $formId,
        'ACTIVE'     => 'Y',
        'TITLE'      => Loc::getMessage('SALE_ORDER_FORM_QUESTION_2'),
        'TITLE_TYPE' => 'text',
        'SID'        => 'PHONE',
        'C_SORT'     => 200,
        'ADDITIONAL' => 'N',
    ...
    $arFields = [
        'FORM_ID'    => $formId,
        'ACTIVE'     => 'Y',
        'TITLE'      => Loc::getMessage('SALE_ORDER_FORM_QUESTION_3'),
        'TITLE_TYPE' => 'text',
        'SID'        => 'EMAIL',
        'C_SORT'     => 300,
        'ADDITIONAL' => 'N',
    ...
    $arFields = [
        'FORM_ID'    => $formId,
        'ACTIVE'     => 'Y',
        'TITLE'      => Loc::getMessage('SALE_ORDER_FORM_QUESTION_4'),
        'TITLE_TYPE' => 'text',
        'SID'        => 'COMPANY',
        'C_SORT'     => 400,
        'ADDITIONAL' => 'N',
    ...
    $arFields = [
        'FORM_ID'    => $formId,
        'ACTIVE'     => 'Y',
        'TITLE'      => Loc::getMessage('SALE_ORDER_FORM_QUESTION_5'),
        'TITLE_TYPE' => 'text',
        'SID'        => 'COMMENT',
        'C_SORT'     => 500,
        'ADDITIONAL' => 'N',
    ...
    $arFields = [
        'FORM_ID'    => $formId,
        'ACTIVE'     => 'Y',
        'TITLE'      => Loc::getMessage('SALE_ORDER_FORM_QUESTION_6'),
        'TITLE_TYPE' => 'text',
        'SID'        => 'DELIVERY',
        'C_SORT'     => 600,
        'ADDITIONAL' => 'N',
    ...
    $arFields = [
        'FORM_ID'    => $formId,
        'ACTIVE'     => 'Y',
        'TITLE'      => Loc::getMessage('SALE_ORDER_FORM_QUESTION_7'),
        'TITLE_TYPE' => 'text',
        'SID'        => 'ADDRESS',
        'C_SORT'     => 700,
        'ADDITIONAL' => 'N',
    ...
    $arFields = [
        'FORM_ID'    => $formId,
        'ACTIVE'     => 'Y',
        'TITLE'      => Loc::getMessage('SALE_ORDER_FORM_QUESTION_8'),
        'TITLE_TYPE' => 'text',
        'SID'        => 'DELIVERY_SUM',
        'C_SORT'     => 800,
        'ADDITIONAL' => 'N',
    ...
    $arFields = [
        'FORM_ID'    => $formId,
        'ACTIVE'     => 'Y',
        'TITLE'      => Loc::getMessage('SALE_ORDER_FORM_QUESTION_9'),
        'TITLE_TYPE' => 'text',
        'SID'        => 'PRODUCTS',
        'C_SORT'     => 900,
        'ADDITIONAL' => 'N',
    ...
    $arFields = [
        'FORM_ID'    => $formId,
        'ACTIVE'     => 'Y',
        'TITLE'      => Loc::getMessage('SALE_ORDER_FORM_QUESTION_10'),
        'TITLE_TYPE' => 'text',
        'SID'        => 'TOTAL',
        'C_SORT'     => 1000,
        'ADDITIONAL' => 'N',
