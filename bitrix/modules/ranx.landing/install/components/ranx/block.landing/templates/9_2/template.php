    ...
    <div class="maxwidth-theme">
        ...
        <div class="employees-wrapper slider--hide-counter <?= $arResult['SLIDER'] ? 'employees--slider' : '' ?>">
            ...
            <div class="row employees">
                ...
                <div class="col-lg-<?= $arResult['COLS'] ? 12 / $arResult['COLS'] : '3'?> col-sm-6 employee-wrap">
                    <div class="employee">
...
<?if ($arResult['SLIDER']):?>
    <script>
        $(document).ready(function () {
            window['block_<?=$arResult['ID']?>_slider'] = new Block9_2Slider(<?=$arResult['ID']?>, <?=$arResult['COLS'] ?: 4?>);
        });
    </script>
<?endif;?>
