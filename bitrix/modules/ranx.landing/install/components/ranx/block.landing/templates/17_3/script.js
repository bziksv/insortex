$(document).ready(function() {
    $('.block17-3').each(function () {
        ...
        component.find('[data-tariffs_slider]').each(function () {
            ...
            $(tariffsSlider).on('init', function (e, slick, currentSlide) {
                $(this).find('.slick-dots li').each(function () {
                    $(this).addClass('theme-bg');
                });

                if (slick.slideCount <= tariffsSlider.data('cols')) {
                    tariffsSlider.find('.slick-dots').addClass('hide-dots');
                }
            ...
            $(tariffsSlider).slick({
                infinite: false,
                slidesToShow: tariffsSlider.data('cols'),
                slidesToScroll: 1,
                arrows: true,
                dots: true,
                cssEase: 'linear',
