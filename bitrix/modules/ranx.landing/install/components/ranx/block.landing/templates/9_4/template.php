...
<?= $arResult['BLOCK_START'] ?>
    ...
    <div class="maxwidth-theme">
        ...
        <div class="block9-4-slider-wrap">
            <a class="slick-arrow arrow-prev btn-transparent">
                <?= Helper::svg('block/arrow_prev') ?>
            </a>
            <div class="block9-4-slider" id="block9-4-slider--<?= $arResult['ID'] ?>">
                <?foreach($arResult['ITEMS'] as $i => $arItem):?>

                    <div class="block9-4-slide-wrap">
                        ...
                        <div class="employee">
                            ...
                            <div class="employee-info-wrap">
                                ...
                                <?if(!empty($arItem['PROPS']['PHONE']) || !empty($arItem['PROPS']['EMAIL']) || !empty($arItem['SOCIALS'])):?>
...
<script>
    $(document).ready(function () {
        let $slider = $('#block9-4-slider--<?= $arResult['ID'] ?>');
