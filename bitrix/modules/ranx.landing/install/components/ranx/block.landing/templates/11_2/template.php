...
<?= $arResult['BLOCK_START'] ?>
    ...
    <? if ($arResult['ITEMS']): ?>
        <div class="map-block <?if($isOneItem):?>one-item<?endif?>">
            ...
            <div class="map-wrapper">
                <div class="map" id="map_<?=$arResult['ID']?>" style="width: 100%; height: 600px"></div>
                <div class="map-empty">
                    <div class="map-empty-icon theme-color"><?= Helper::svg('block/map_empty') ?></div>
                    <div class="map-empty-title"><?= Loc::getMessage('RX_BLOCK_LANDING_11_2_MAP_EMPTY_TITLE') ?></div>
                    <div class="map-empty-desc"><?= Loc::getMessage('RX_BLOCK_LANDING_11_2_MAP_EMPTY_DESC') ?></div>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function closeBalloons11_2(objects) {
