...
<div class="modal4_2">
    <div class="modal4_2-title"><?=$arResult['NAME']?></div>

    <?if(!empty($arResult['IMG'])):?>
        <div class="modal4_2-picture">
            <img src="<?=$arResult['IMG']?>" alt="<?=$arResult['NAME']?>" title="<?=$arResult['NAME']?>">
        </div>
    <?endif?>

    <div class="modal4_2-service">
    ...
    <?if(!empty($arResult['PREVIEW_TEXT'])):?>
        <div class="modal4_2-preview-text">
            <?=$arResult['PREVIEW_TEXT']?>
        </div>
    <?endif?>

    <?if(!empty($arResult['DETAIL_TEXT'])):?>
        <div class="modal4_2-detail-text">
            <?=$arResult['DETAIL_TEXT']?>
        </div>
    <?endif?>

    <?if($arResult['PROPS']['CHARS']):?>
        <div class="modal4_2-chars">
            <div class="title">
