...
$formCode = 'ranx_landing_form_order';
...
if (!CEventType::GetList(['TYPE_ID' => $eventType])->SelectedRowsCount()) {
    ...
    $arFields = [
        ...
        'EVENT_TYPE'  => 'email',
        'NAME'        => Loc::getMessage('ORDER_EVENT_NAME'),
        'DESCRIPTION' => Loc::getMessage('ORDER_EVENT_DESCRIPTION')
    ];
...
$arFields = [
    ...
    'SUBJECT'    => Loc::getMessage('ORDER_EVENT_MESSAGE_SUBJECT'),
    'MESSAGE'    => Loc::getMessage('ORDER_EVENT_MESSAGE_MESSAGE'),
    'BODY_TYPE'  => 'html',
];
...
if ($formId) {
    ...
    // add new
    $arFields = [
        'NAME'				=> Loc::getMessage('ORDER_FORM_NAME'),
        'SID'				=> $formCode,
        'C_SORT'			=> 300,
        'BUTTON'			=> Loc::getMessage('ORDER_BUTTON_NAME'),
        'DESCRIPTION'		=> Loc::getMessage('ORDER_FORM_DESCRIPTION'),
        'DESCRIPTION_TYPE'	=> 'text',
        'STAT_EVENT1'		=> 'form',
        'STAT_EVENT2'		=> '',
        'arSITE'			=> $arFormSiteIds,
        'arMENU'			=> ['ru' => Loc::getMessage('ORDER_FORM_NAME')],
    ...
    $arFields = [
        'FORM_ID'    => $formId,
        'ACTIVE'     => 'Y',
        'TITLE'      => Loc::getMessage('ORDER_FORM_QUESTION_1'),
        'TITLE_TYPE' => 'text',
        'SID'        => 'NAME',
        'C_SORT'     => 100,
        'ADDITIONAL' => 'N',
    ...
    $arFields = [
        'FORM_ID'    => $formId,
        'ACTIVE'     => 'Y',
        'TITLE'      => Loc::getMessage('ORDER_FORM_QUESTION_2'),
        'TITLE_TYPE' => 'text',
        'SID'        => 'PHONE',
        'C_SORT'     => 200,
        'ADDITIONAL' => 'N',
    ...
    $arFields = [
        'FORM_ID'    => $formId,
        'ACTIVE'     => 'Y',
        'TITLE'      => Loc::getMessage('ORDER_FORM_QUESTION_3'),
        'TITLE_TYPE' => 'text',
        'SID'        => 'EMAIL',
        'C_SORT'     => 300,
        'ADDITIONAL' => 'N',
    ...
    $arFields = [
        'FORM_ID'    => $formId,
        'ACTIVE'     => 'Y',
        'TITLE'      => Loc::getMessage('ORDER_FORM_QUESTION_4'),
        'TITLE_TYPE' => 'text',
        'SID'        => 'SUBJECT',
        'C_SORT'     => 400,
        'ADDITIONAL' => 'N',
    ...
    $arFields = [
        'FORM_ID'    => $formId,
        'ACTIVE'     => 'Y',
        'TITLE'      => Loc::getMessage('ORDER_FORM_QUESTION_5'),
        'TITLE_TYPE' => 'text',
        'SID'        => 'QUESTION',
        'C_SORT'     => 500,
        'ADDITIONAL' => 'N',
    ...
    $arFields = [
        'FORM_ID'    => $formId,
        'ACTIVE'     => 'Y',
        'TITLE'      => Loc::getMessage('ORDER_FORM_QUESTION_6'),
        'TITLE_TYPE' => 'text',
        'SID'        => 'SOURCE',
        'C_SORT'     => 600,
        'ADDITIONAL' => 'N',
