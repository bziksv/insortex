...
switch ($arResult["COLS"]) {
    case 2:
        ...
        break;
    case 3:
        $arResult['BLOCK_CLASSES'] = "col-lg-4 col-md-12 col-sm-6";
        break;
    case 4:
        $arResult['BLOCK_CLASSES'] = "col-xl-3 col-lg-4 col-md-6 col-sm-12";
        break;
    default:
        $arResult['BLOCK_CLASSES'] = "col-lg-4 col-md-12 col-sm-12";
}
