if (typeof Block9_2Slider === 'undefined') {
    function Block9_2Slider(blockId, cols) {
    ...
    Block9_2Slider.prototype.initSlider = function () {
        this.$slider.slick({
            infinite: true,
            dots: true,
    ...
    Block9_2Slider.prototype.getBreakpoints = function () {
        let result = [
    ...
    Block9_2Slider.prototype.getDisplaySlideCount = function () {
    ...
    Block9_2Slider.prototype.dotsHandler = function (e, slick) {
        slick.$slider.find('.slick-dots li').each(function () {
            $(this).addClass('theme-bg');
        });
    };

    Block9_2Slider.prototype.lazyLoadHandler = function () {
        if (typeof lazyLoadInstance !== 'undefined') {
            lazyLoadInstance.update();
        }
    };

    Block9_2Slider.prototype.paginationHandler = function (e, slick, currentSlide) {
        ...
        slick.$slider.toggleClass('slider--hide-dots', slideCount <= displaySlideCount || slideCount > 12);
    };

    Block9_2Slider.prototype.subscribeOnEvents = function () {
