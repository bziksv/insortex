if (typeof Block9_1Slider === 'undefined') {
    function Block9_1Slider(blockId, cols) {
    ...
    Block9_1Slider.prototype.initSlider = function () {
        this.$slider.slick({
            infinite: true,
            dots: true,
    ...
    Block9_1Slider.prototype.getBreakpoints = function () {
        let result = [
    ...
    Block9_1Slider.prototype.getDisplaySlideCount = function () {
    ...
    Block9_1Slider.prototype.dotsHandler = function (e, slick) {
        slick.$slider.find('.slick-dots li').each(function () {
            $(this).addClass('theme-bg');
        });
    };

    Block9_1Slider.prototype.lazyLoadHandler = function () {
        if (typeof lazyLoadInstance !== 'undefined') {
            lazyLoadInstance.update();
        }
    };

    Block9_1Slider.prototype.paginationHandler = function (e, slick, currentSlide) {
    ...
    Block9_1Slider.prototype.subscribeOnEvents = function () {
