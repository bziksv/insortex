                    ...
                    <div class="tariff <?= $arResult['BLOCK_CLASSES']; ?>">
                        ...
                        <div class="tariff_wrapper">
                            ...
                            <div class="tariff-img lazy"
                                 <?if($useLazyLoad):?> data-bg="<?=$arItem['IMG']?>" style="background:center top/cover no-repeat;"
                                 <?else:?> style="background:url(<?= $arItem['IMG']; ?>) center top/cover no-repeat;"
                                 <?endif?>>
                            </div>
                            <?endif?>
                                    ...
                                    <?if($arItem['OLD_PRICE']):?>
                                        <div class="tariff-discount text-center">
                                            ...
                                            <div class="discount-text">
                                                <?= Loc::getMessage('RX_BLOCK_LANDING_17_1_ECONOMY') ?> <?=Helper::money($arItem['DISCOUNT_PRICE'])?>
                                            </div>
                                        </div>
                                    <?endif?>
                                </div>
